...
export default class Example {
  ...
  render(images) {
    ...
    // Shape rectangle - 1
    const material1 = new v1.Material({ color: { r: 0.0, g: 0.5, b: 0.0, a: 1.0 }, image: images[0] })
    ...
    // Shape rectangle - 2
    const material2 = new v1.Material({ color: { r: 0.0, g: 0.0, b: 0.5, a: 1.0 }, image: images[1] })
    ...
    // Shape triangle - 3
    const material3 = new v1.Material({ color: { r: 0.5, g: 0.0, b: 0.0, a: 1.0 }, image: images[2] })
    ...
    // Shape triangle - 4
    const material4 = new v1.Material({ color: { r: 0.0, g: 0.5, b: 0.5, a: 1.0 }, image: images[3] })
